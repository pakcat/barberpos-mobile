            ...
            child: CustomScrollView(
              slivers: [
                ...
                Obx(() {
                  ...
                  final isGrid = controller.viewMode.value == ProductViewMode.grid;
                      ...
                      sliver: SliverGrid(
                        ...
                        delegate: SliverChildBuilderDelegate(
                          (context, index) => _ProductCard(
                            item: items[index],
                            onEdit: () =>
                                Get.toNamed(Routes.productForm, arguments: items[index].id),
                      ...
                      delegate: SliverChildBuilderDelegate(
                        (context, index) => Padding(
                          padding: EdgeInsets.only(
                            bottom: index == items.length - 1 ? 0 : AppDimens.spacingSm,
                          ),
                          child: _ProductRow(
                            item: items[index],
                            onEdit: () =>
...
class _ProductCard extends StatelessWidget {
  const _ProductCard({required this.item, required this.onEdit, required this.onDelete});
                      ...
                      children: [
                        InkWell(
                          ...
                          child: Container(
                            ...
                            child:
                                const Icon(Icons.edit_rounded, size: 16, color: AppColors.orange500),
                          ),
                        ),
                        const SizedBox(width: AppDimens.spacingSm),
                        InkWell(
                          ...
                          child: Container(
                            ...
                            child:
                                const Icon(Icons.delete_rounded, size: 16, color: AppColors.red500),
                          ),
                        ),
                      ],
                    ),
...
class _ProductRow extends StatelessWidget {
  const _ProductRow({required this.item, required this.onEdit, required this.onDelete});
